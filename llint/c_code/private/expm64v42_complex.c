...
void dpade(const mxArray *prhs0, mxArray *plhs[], mwSize nrowsA, mwSize ncolumnsA, int p_poldegree, mxDouble s)
{
    ...
    case 5:
        ...
        c = (-2.0) * 3.306878306878306e-05;
        /*
         * Aux = -2*c1 - 2*c3*A^2 - 2*c5*A^4
         */
        daxpy(&total, &c, Ak, &onei, Aux, &onei);
